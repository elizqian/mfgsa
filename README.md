...
The file `main.m` computes multifidelity variance and sensitivity index estimates for the Ishigami function example considered in the paper. This code was written in MATLAB R2017b. 
